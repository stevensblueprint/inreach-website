...
import { PageBlocksHeader, PageBlocksHeaderNavLinks, PageBlocksHeaderNavLinksLinkUrls } from '~tina/__generated__/types'
...
import { inputClasses } from '../../../components/fields/ColorSelector/colors'
  ...
  export const Header = ({data}: {data: PageBlocksHeader}) => {
    return (
      <header className={cn('w-full h-20 flex justify-center items-center', data.navBGColor ? inputClasses[data.navBGColor] : 'bg-white')}>
