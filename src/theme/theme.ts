...
export const commonTheme = {
	...
	components: {
		ActionIcon: {
			defaultProps: (theme: { other: { colors: { secondary: { cornflower: any } } } }) =>
				({
		...
		Anchor: {
			styles: (theme: { spacing: { sm: any }; other: { utilityFonts: { utility1: any }; colors: { primary: { lightGray: any } } }; fn: { hover: (arg0: { backgroundColor: any; textDecoration: string }) => any } }) => ({
				root: {
		...
		Badge: {
			...
			styles: (theme: { spacing: { xxs: any; sm: any }; other: { fontWeight: { semibold: any }; colors: { secondary: { black: any } } } }) =>
				({
					root: {
		...
		Button: {
			...
			styles: (theme: { spacing: { sm: any; xl: any }; other: { colors: { secondary: { black: any; darkGray: any; white: any }; primary: { lightGray: any } }; utilityFonts: { utility1: any } }; fn: { hover: (arg0: { background: any }) => any; lighten: (arg0: any, arg1: number) => any } }) => ({
				root: {
		...
		Card: {
			...
			styles: (theme: { fn: { largerThan: (arg0: string) => any } }) => ({
				root: {
		...
		Checkbox: {
			styles: (theme: { fn: { hover: (arg0: { backgroundColor: any }) => any }; other: { colors: { primary: { lightGray: any }; secondary: { darkGray: any; white: any; black: any }; tertiary: { coolGray: any } }; utilityFonts: { utility2: any } }; spacing: { xs: any; xl: any } }, params: CheckboxStylesParams) =>
				({
					root: {
		...
		Divider: {
			defaultProps: (theme: { other: { colors: { tertiary: { coolGray: any } } } }) => ({
				size: rem(1),
		...
		Drawer: {
			styles: (theme: { other: { colors: { primary: { lightGray: any } } } }) =>
				({
					content: {
		...
		Input: {
			styles: (theme: { other: { colors: { tertiary: { coolGray: any; red: any }; secondary: { darkGray: any; black: any }; primary: { lightGray: any } }; utilityFonts: { utility2: any } }; radius: { xl: any }; spacing: { md: any } }) =>
				({
					input: {
						borderColor: theme.other.colors.tertiary.coolGray,
						borderRadius: rem(8),
		...
		InputWrapper: {
			...
			styles: (theme: { other: { utilityFonts: { utility4: any; utility3: any }; colors: { secondary: { darkGray: any } } } }) =>
				({
					label: {
						fontSize: rem(16),
						paddingBottom: 0,
		...
		Loader: {
			defaultProps: (theme: { other: { colors: { secondary: { darkGray: any } } } }) => ({
				color: theme.other.colors.secondary.darkGray,
			}),
		},
		LoadingOverlay: {
		...
		Modal: {
			defaultProps: (theme: { radius: { xl: any } }) => {
				return {
			...
			styles: (theme: { fn: { largerThan: (arg0: string) => any }; other: { colors: { primary: { lightGray: any } } } }) =>
				({
					content: {
		...
		PaginationRoot: {
			defaultProps: (theme: { other: { colors: { secondary: { white: any } } } }) => ({
				siblings: 0,
				color: theme.other.colors.secondary.white,
			}),
		},
		Paper: {
			styles: (theme: { other: { colors: { tertiary: { coolGray: any } } } }) => ({
				root: {
					padding: rem(20),
					borderRadius: rem(16),
					'&[data-with-border]': {
		...
		PasswordInput: {
			styles: (theme: { other: { utilityFonts: { utility2: any }; colors: { secondary: { darkGray: any } } } }) => ({
				innerInput: {
					height: 'unset',
					...theme.other.utilityFonts.utility2,
					'&::placeholder': {
		...
		Radio: {
			styles: (theme: { fn: { hover: (arg0: { backgroundColor: any }) => any }; other: { colors: { primary: { lightGray: any }; secondary: { white: any; black: any } }; utilityFonts: { utility2: any } } }) =>
				({
					root: {
		...
		Skeleton: {
			defaultProps: () =>
				({
					radius: 'xl',
				}) satisfies: any SkeletonProps: any,
			styles: (theme: any, { circle }: SkeletonStylesParams) =>
				({
					root: {
						minWidth: circle ? undefined : rem(100),
					},
				}) satisfies: any Styles: any<'root', SkeletonStylesParams>,

			variants: variants.Skeleton,
		},
		Slider: {
			defaultProps: (theme: { other: { colors: { secondary: { black: any } } } }) =>
				({
					thumbSize: 12,
					label: null,
				}) satisfies SliderProps,
			styles: (theme: { other: { colors: { secondary: { black: any } } } }) =>
				({
					bar: {
						height: rem(2),
						backgroundColor: theme.other.colors.secondary.black,
		...
		Switch: {
			...
			styles: (theme: { fn: { hover: (arg0: { backgroundColor: any }) => any; darken: (arg0: any, arg1: number) => any }; other: { colors: { primary: { lightGray: any }; secondary: { darkGray: any; white: any; black: any }; tertiary: { coolGray: any } }; utilityFonts: { utility2: any } } }) =>
				({
					root: {
		...
		Tabs: {
			styles: (theme: { other: { colors: { secondary: { black: any }; primary: { lightGray: any } }; utilityFonts: { utility1: any } }; fn: { hover: (arg0: { backgroundColor: any }) => any } }) =>
				({
					tab: {
		...
		Text: {
			defaultProps: (theme: { other: { fontWeight: { regular: any }; colors: { secondary: { black: any } } } }) => ({
				component: 'span',
		...
		TextInput: {
			styles: (theme: { radius: { xl: any }; spacing: { md: any } }) => ({
				input: {
					height: rem(48),
				},
				withIcon: {
		...
		Title: {
			styles: (theme: { fn: { smallerThan: (arg0: number) => any }; headings: { sizes: { h1: { fontSize: any }; h2: { fontSize: any }; h3: { fontSize: any }; h4: { fontSize: any }; h5: { fontSize: any }; h6: { fontSize: any } } } }) =>
				({
					root: {
						'&:is(h1)': {
							marginTop: 0,
		...
		TypographyStylesProvider: {
			styles: (theme: { headings: { sizes: { [x: string]: { fontSize: any } } }; fontSizes: { md: any } }) => {
