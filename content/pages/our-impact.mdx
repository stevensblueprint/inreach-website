...
blocks:
  ...
  - richTextContent: >
    ...
    _template: richText
  - richTextContent: "## InReach App Features\U0001F4F1\n"
    _template: richText
  - heading: ''
  ...
  - verticalAlignment: top
    ...
    richTextRight: >
      ...
      age/income/residence, or a referral) to access.
       ...
       <ColoredText text="Leave Ratings and Reviews" color="Ally Green" />: Logged-in users can share public ratings (one to five stars) and reviews on all verified service providers’ profile pages. 
      ...
      InReach’s Resource Team.
       ...
       <ColoredText text="Save Resources" color="Ally Green" />: Logged-in users can bookmark their favorite resources for easy access later. 
